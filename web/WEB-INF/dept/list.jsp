...
<body>
<!-- 内容主体区域 -->
<form  class="layui-form" action="/dept?crud=list" id="query" method="get">
    ...
    layui.use(['table', 'layer', 'laypage'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'name', title: '部门名称', width: 200,align:'center'}
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    $.get('/dept?crud=delete',{id:data.id},function (data) {
                        /*alert(data);*/
                        obj.del();
                        /*window.location.reload();*/
                        layer.close(index);
                        ...
                        layer.open({
                            ...
                            success: function (layero) {
                                ...
                                btn.find('.layui-layer-btn0').click(function () {
                                    ...
                                    $.post("/dept",{id:data.id,name:user,remark:sta},function (data) {
                                        alert(data)
                                        window.location.reload();
                                    });
                                    /*$("#hd").val(data.id);
...
<div style="display: none" id="wai">
    <div id="rd" style="padding: 30px; line-height: 22px; background-color: white ; font-weight: 300; ">
        <form class="layui-form layui-form-pane" action="/dept" method="post" id="myform">
