...
<body>
<!-- 内容主体区域 -->
<form  class="layui-form" action="/doc?crud=list" id="query" method="get">
...
<script type="text/html" id="barDemo">
    <button class="layui-btn layui-btn-xs edit" lay-event="edit" data-method="notice">下载</button>
    ...
    layui.use(['table', 'layer', 'laypage'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'title', title: '标题', width: 80, fixed: 'left',align:'center'}
                , {field: 'filename', title: '文件名', width: 200,align:'center'}
                , {field: 'time', title: '创建时间', width: 200,align:'center'}
                , {field: 'name', title: '创建人',align:'center',templet:function(d){return d.user?d.user.username:"";}}
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    $.get('/doc?crud=delete',{id:data.id,filename:data.filename},function (data) {
                        /*alert(data);*/
                            obj.del();
                        /*window.location.reload();*/
                        layer.close(index);
                ...
                var active = {
                    notice: function () {
                        ...
                        form.append($("<input></input>").attr("type", "hidden").attr("name", "crud").attr("value", "download"));
